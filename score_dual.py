...
if __name__ == '__main__':
	...
	parser.add_argument('--model1', choices=['lstm', 'resnet', 'resnet_pca', 'wideresnet', 'lcnn_9', 'lcnn_29', 'lcnn_9_pca', 'lcnn_29_pca', 'lcnn_9_prodspec', 'lcnn_9_icqspec', 'lcnn_9_CC', 'lcnn_29_CC', 'resnet_CC', 'TDNN', 'TDNN_multipool', 'TDNN_LSTM', 'FTDNN', 'mobilenet', 'densenet', 'VGG'], default='lcnn_9', help='Model arch')
	parser.add_argument('--resnet1-type', choices=['18', '28', '34', '50', '101', 'se_18', 'se_28', 'se_34', 'se_50', 'se_101', '2net_18', '2net_se_18'], default='18', help='Resnet arch')
	parser.add_argument('--vgg1-type', choices=['VGG11', 'VGG13', 'VGG16', 'VGG19'], default='VGG16', help='VGG arch')
	parser.add_argument('--model2', choices=['lstm', 'resnet', 'resnet_pca', 'wideresnet', 'lcnn_9', 'lcnn_29', 'lcnn_9_pca', 'lcnn_29_pca', 'lcnn_9_prodspec', 'lcnn_9_icqspec', 'lcnn_9_CC', 'lcnn_29_CC', 'resnet_CC', 'TDNN', 'TDNN_multipool', 'TDNN_LSTM', 'FTDNN', 'mobilenet', 'densenet', 'VGG'], default='lcnn_9', help='Model arch')
	parser.add_argument('--resnet2-type', choices=['18', '28', '34', '50', '101', 'se_18', 'se_28', 'se_34', 'se_50', 'se_101', '2net_18', '2net_se_18'], default='18', help='Resnet arch')
	...
	if args.model1 == 'lstm':
	...
	elif args.model1 == 'wideresnet':
		model1 = model_.WideResNet()
	...
	elif args.model1 == 'TDNN_multipool':
		model1 = model_.TDNN_multipool(ncoef=args.ncoef1, init_coef=args.init_coef1)
		...
		model1 = model_.MobileNetV3_Small()
	elif args.model1 == 'densenet':
		model1 = model_.DenseNet()
	...
	if args.model2 == 'lstm':
	...
	elif args.model2 == 'wideresnet':
		model2 = model_.WideResNet()
	...
	elif args.model2 == 'TDNN_multipool':
		model2 = model_.TDNN_multipool(ncoef=args.ncoef2, init_coef=args.init_coef2)
		...
		model2 = model_.MobileNetV3_Small()
	elif args.model2 == 'densenet':
		model2 = model_.DenseNet()
	...
	if not args.no_eer and not args.eval and args.trials_path:
		for score_type in score_types:
			...
			print('BCE: {}'.format(torch.nn.BCELoss()(torch.Tensor(preds[score_type]), y)))
