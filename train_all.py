...
if args.logdir:
	writer = SummaryWriter(log_dir=args.logdir, comment=args.model_la+'-_-'+args.model_pa+'-_-'+args.model_mix, purge_step=True)
else:
	writer = None
...
optimizer_pa = TransformerOptimizer(optim.Adam(model_pa.parameters(), betas=(args.b1, args.b2), weight_decay=args.l2), lr=args.lr, warmup_steps=args.warmup)
optimizer_mix = TransformerOptimizer(optim.Adam(model_mix.parameters(), betas=(args.b1, args.b2), weight_decay=args.l2), lr=args.lr, warmup_steps=args.warmup)
