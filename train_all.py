...
parser.add_argument('--resnet-type-la', choices=['18', '28', '34', '50', '101'], default='18', help='Resnet arch')
parser.add_argument('--resnet-type-pa', choices=['18', '28', '34', '50', '101'], default='18', help='Resnet arch')
parser.add_argument('--resnet-type-mix', choices=['18', '28', '34', '50', '101'], default='18', help='Resnet arch')
